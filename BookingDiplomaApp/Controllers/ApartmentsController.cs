...
namespace BookingDiplomaApp.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Apartments.Include(a => a.Category).Include(a => a.City);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,CityId,CategoryId,Address,Places,Square,RoomsCount,DistanceFromCenter")] Apartment apartment)
        {
